...
#  python3 distributed_vehicle_teleop_app.py --driver --worker --address 100.70.20.114 --fragments SteeringWheelFragment
#  python3 distributed_vehicle_teleop_app.py --driver --master --address 100.70.20.114 --fragments PandaFragment
def main():
    app = TeleopApp()
    app.run()
